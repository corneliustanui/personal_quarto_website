...
Similar to @sec-bands,this variable follows a binomial distribution with 3 trials; male (49.0%), female (50.0%), and intersex (0.01%)[^7]. Because of the small number of observations for the third category, we shall limit the trials to just 2 and and add 1 to the result to remove 0 and introduce 3.
