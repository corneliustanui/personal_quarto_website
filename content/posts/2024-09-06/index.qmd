...
As noted in @sec-shallow, AI requires massive data to be trained on before it can be deployed for use, just a student requires a couple of lessons before sitting an exam.
